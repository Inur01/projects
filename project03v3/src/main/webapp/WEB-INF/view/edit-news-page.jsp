...
<form:form action="show-edited-content" modelAttribute="editModel" method="get">

		<!-- ID: ${editModel.id} 
		
		<br /> -->
		<br />
		Title: <form:input placeholder="Title" path="newsTitle" />
		...
		<br />
		<br />
		<button type="submit" id="backToStartPage" name="idForUpdate" value="${editModel.id}">Save</button>
</form:form>
	<br/>
<form action="/project03v3/startpage/mainpage"><button type="submit">Cancel</button></form>
</div>
